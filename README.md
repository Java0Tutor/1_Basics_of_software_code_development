...
Описание файлов:
 ...
 - Recommendations.pdf - файл содержит рекомендуемые материалы (видео и книги), к которым следуюет обратиться при возникновении трудностй при решении задач или ответах на вопросы.
